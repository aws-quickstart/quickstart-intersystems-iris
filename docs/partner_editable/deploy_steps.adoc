...
[cols="3,1"]
|===
^|https://fwd.aws/rzj7E[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://fwd.aws/bxyWv[View template^]

^|https://fwd.aws/Av3ER[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://fwd.aws/3YgkD[View template^]
|===
